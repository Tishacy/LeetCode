 ...
 *     答案保证小于 2 ^ 31
 */
public class WalkingRobotSimulationOOP_874 {
    public static void main(String[] args) {
        WalkingRobotSimulationOOP_874 solution = new WalkingRobotSimulationOOP_874();
    ...
    public int robotSim(int[] commands, int[][] obstacles) {
        // 用 set 存储障碍，方便之后用 O(1) 的时间复杂度去找是否遇到了障碍物
